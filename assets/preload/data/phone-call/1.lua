	...
	if healthBarIsFlip == true then
		...
		if stickThere == false then
			if getProperty('health') > 0 then
				setProperty('iconP1.x', 216+getProperty('health')*296+getProperty('healthBar.x')-340)
				setProperty('iconP2.x', 317+getProperty('health')*297+getProperty('healthBar.x')-350)
			end

			if getProperty('health') <= 0 then
				setProperty('iconP1.x', 216+getProperty('healthBar.x')-340)
				setProperty('iconP2.x', 317+getProperty('healthBar.x')-350)
			end
		end

		if stickThere == true then
		   setProperty('iconP1.x', 808+getProperty('healthBar.x')-340.5)
		   setProperty('iconP2.x', 911+getProperty('healthBar.x')-350.5)
		end
