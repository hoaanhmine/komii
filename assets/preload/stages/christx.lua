...
function onCreate()
	...
	makeLuaSprite('TheWindow', 'christ/images/TheWindow', -815, -290);
	setScrollFactor('TheWindow', 0.2, 0.2);
	scaleObject('TheWindow',1, 1)
	addLuaSprite('TheWindow', false);
    
    makeAnimatedLuaSprite('boppers', 'christ/images/cocnew/boppers', -675, -290);
    setLuaSpriteScrollFactor('boppers', 0.31, 0.31);		
	scaleObject('boppers',1, 1)
    addAnimationByPrefix('boppers','idle', 'BG DUMBS',24,true);
	...
	makeAnimatedLuaSprite('boppers1', 'christ/images/cocnew/boppers', -480, 480);
    setLuaSpriteScrollFactor('boppers1', 0.3, 0.6);		
	scaleObject('boppers1',1, 1)
    addAnimationByPrefix('boppers1','idle', 'Gays',24,true);
	addLuaSprite('boppers1', false);
	...
	makeAnimatedLuaSprite('boppers3', 'christ/images/cocnew/boppers',-620, 400);
    setLuaSpriteScrollFactor('boppers3', 0.5, 0.6);		
	scaleObject('boppers3',1, 1)
    addAnimationByPrefix('boppers3','idle', 'leaked guy',24,true);
	addLuaSprite('boppers3', false);
	...
	makeAnimatedLuaSprite('boppers4', 'christ/images/cocnew/boppers',-790, 400);
    setLuaSpriteScrollFactor('boppers4', 1, 1);		
	scaleObject('boppers4',1, 1)
    addAnimationByPrefix('boppers4','idle', 'Cass',24,true);
	addLuaSprite('boppers4', false);
	
	makeAnimatedLuaSprite('boppers5', 'christ/images/cocnew/boppers',1420, 360);
    setLuaSpriteScrollFactor('boppers5', 1, 1);		
	scaleObject('boppers5',1, 1)
    addAnimationByPrefix('boppers5','idle', 'zona',24,true);
	addLuaSprite('boppers5', false);
	
	makeAnimatedLuaSprite('boppers6', 'christ/images/SmoothCC',120, -190);
    setLuaSpriteScrollFactor('boppers6', 1, 1);		
	scaleObject('boppers6',1, 1)
    addAnimationByPrefix('boppers6','idle', 'castle crashers',24,true);
	addLuaSprite('boppers6', false);
